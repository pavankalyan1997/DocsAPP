...
public class DoctorInboxTab2Pharmacist extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("DoctorInBox").child("Pharmacist");
        ...
        firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<MessageToPharmacist, ViewHolder>(MessageToPharmacist.class
            ...
            protected void populateViewHolder(ViewHolder viewHolder, final MessageToPharmacist model, int position) {
                viewHolder.txtView.setText(model.getPharmaName());
