...
public class PharmacistInboxTabbed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacist_inbox_tabbed);

        mAuth=FirebaseAuth.getInstance();
        FirebaseUser user=mAuth.getCurrentUser();

        drawerLayout=(DrawerLayout)findViewById(R.id.DrawerLayoutPharmacistInBoxTabbed);
        Toggle=new ActionBarDrawerToggle(this,drawerLayout,R.string.open,R.string.close);

        drawerLayout.addDrawerListener(Toggle);
        Toggle.syncState();

        navigationView=(NavigationView)findViewById(R.id.navigationViewPharmacistInBoxTabbed);
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new PharmacistInboxTab1Doctor(),"Doctor");
    ...
    private void LogOutAsPharmacist() {
        ...
        finish();
        Intent intent= new Intent(PharmacistInboxTabbed.this, Home.class);
