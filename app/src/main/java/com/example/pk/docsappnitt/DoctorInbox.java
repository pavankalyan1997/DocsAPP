...
public class DoctorInbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout=(DrawerLayout)findViewById(R.id.DrawerLayoutDoctorInbox);
        Toggle=new ActionBarDrawerToggle(this,drawerLayout,R.string.open,R.string.close);

        drawerLayout.addDrawerListener(Toggle);
        Toggle.syncState();

        navigationView=(NavigationView)findViewById(R.id.navigationViewDoctorInbox);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DoctorInbox.this));
        //FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        mAuth=FirebaseAuth.getInstance();
        FirebaseUser user=mAuth.getCurrentUser();
        databaseReference= FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("DoctorInBox");
            ...
            protected void populateViewHolder(Inbox.ViewHolder viewHolder, final MessageToDoctor model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent=new Intent(DoctorInbox.this,MessageViewForDoctor.class);
    ...
    private void DoctorInboxOpen(){
        startActivity(new Intent(this,DoctorInbox.class));
    }
    private void LogOutAsDoctor() {
        ...
        finish();
        Intent intent= new Intent(DoctorInbox.this, Home.class);
